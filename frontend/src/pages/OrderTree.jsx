...
function OrderTree(){
     ...
     return <div>
         <div className="bg-courseTitle w-[100%] h-[480px]" >
           ...
           <h1 className="text-white text-2xl font-bold p-10 ml-20">react FOR PROFISIONAL </h1>
            ...
            <div className="coursePrifile">
             ...
             <i className="fa-solid text-3xl ml-5 mt-5 text-green-500 fa-chalkboard"></i>
              <h3 className="mt-6 ml-2">12 Hours and 30 minutes Of HD Videos</h3>
              </div>
              <div className="list">
             ...
             <i className="fa-solid text-3xl ml-5 mt-5 text-green-500 fa-certificate"></i>
              ...
              <button className="btn" type="button">Enroll Now</button>
