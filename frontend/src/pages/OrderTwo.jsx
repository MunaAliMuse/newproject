    ...
    const verifyUser = ()=> {
      ...
      return <div>
          ...
          <div className="bg-courseTitle w-[100%] h-[480px]" >
            ...
            <h1 className="text-white text-2xl font-bold p-10 ml-20">Nodejs FOR PROFISIONAL </h1>
              ...
              <h4 className="ml-20 text-white text-3xl">Last Updated: 29/02/2024</h4>
             <div className="tit-profileUploader">
             <div className="profileUploader"></div> <h2>mahamed ALI</h2>
